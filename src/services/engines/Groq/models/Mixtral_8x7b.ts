...
export interface Mixtral_8x7bI extends GroqModel {
  model: 'mixtral-8x7b';
}

export class Mixtral_8x7b implements Mixtral_8x7bI {
  readonly model = 'mixtral-8x7b';
