<template>
  <div class="full-width card-background text-white q-py-sm">
    <div class="chat-message q-pa-md row">
      <div class="col-12 q-pb-md row">
        ...
        <div class="col row q-col-gutter-x-sm">
          <div class="col-12 self-center flat-line-height text-h6 text-weight-bold opacity-75">
        ...
        <div class="col-auto row">
          ...
          <transition name="fade" mode="out-in">
            <q-btn
              ...
              dense
              icon="stop_circle"
              color="red-4 opacity-50 opacity-h-75 transition-025"
      ...
      <div v-if="message.content.value.chunks" class="col-12 row">
        <div class="col-12" v-for="(chunk, index) of message.content.value.chunks" :key="chunk.raw">
          <chat-message-chunk
            ...
            :raw="chunk.raw"
            :index="index"
            :parentLength="message.content.value.chunks.length"
          />
        </div>
        ...
        <div v-if="message.images.length" class="col-12 row q-pt-sm">
          <div class="col-4 q-pa-sm" v-for="image of message.images" :key="image.src">
            <q-img
              :src="image.src"
              class="full-width"
              style="border-radius: 10%; aspect-ratio: 1"
            />
          </div>
        </div>
      </div>
